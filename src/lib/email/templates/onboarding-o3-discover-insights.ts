interface OnboardingO3Params {
  userName?: string
  locale?: string
}

export function onboardingO3DiscoverInsightsHtml(params: OnboardingO3Params): string {
          ...
          <tr>
            <td style="padding:40px 40px 24px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:8px;margin-bottom:12px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#a855f7;">${t.feature1Icon} ${t.feature1Title}</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:8px;margin-bottom:12px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#f59e0b;">${t.feature2Icon} ${t.feature2Title}</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:8px;margin-bottom:8px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#22c55e;">${t.feature3Icon} ${t.feature3Title}</p>
