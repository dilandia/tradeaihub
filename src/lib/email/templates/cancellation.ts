...
export function cancellationEmailHtml(params: CancellationParams): string {
  ...
  const t = {
    ...
    lose1: isPt ? `Agentes de IA ilimitados` : `Unlimited AI agents`,
    lose2: isPt ? `Importacoes ilimitadas` : `Unlimited imports`,
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#121212;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 40px 24px;">
              ...
              <p style="margin:0 0 12px;font-size:15px;line-height:1.6;color:#94a3b8;">${t.loseTitle}</p>
              <!-- Features list -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:8px;overflow:hidden;">
                <tr>
                  <td style="padding:16px 24px;">
                    <p style="margin:0 0 8px;font-size:14px;line-height:1.6;color:#f87171;">&#10005; ${t.lose1}</p>
                    <p style="margin:0 0 8px;font-size:14px;line-height:1.6;color:#f87171;">&#10005; ${t.lose2}</p>
                    <p style="margin:0 0 8px;font-size:14px;line-height:1.6;color:#f87171;">&#10005; ${t.lose3}</p>
                    <p style="margin:0;font-size:14px;line-height:1.6;color:#f87171;">&#10005; ${t.lose4}</p>
                  </td>
                </tr>
              </table>
